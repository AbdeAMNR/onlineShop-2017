...
(function (factory) {
    ...
    CoreSlider = function (container, options) {
        ...
        var defaults = {
            ...
            // Callbacks API
            before: function () {
            }, // Callback function - fires before each slider animation
            after: function () {
            },  // Callback function - fires after each slider animation
            init: function () {
            },   // Callback function - fires after slider was initialized
        };
        ...
        if (typeof options === 'object') {
            ...
            switch (options) {
                ...
                case 'destroy':
                    ...
                    break;
                case 'next':
                    $slider.setSlide($slider.getCurrentSlideIndex() + 1, true, true);
                    break;
                case 'prev':
                    $slider.setSlide($slider.getCurrentSlideIndex() - 1, true, true);
                    break;
